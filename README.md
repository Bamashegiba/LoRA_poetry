...
В рамках лабораторной работы был получен опыт взаимодействия с LLM, были получены навыки дообучения LLM с помощью LoRA, проведено сравнение результатов генерации стиход до дообучения и после. Выявлен положительный эффект дообучения в виде увеличения схожести со стилем автора в среднем на 50%
